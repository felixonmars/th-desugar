...
-- @
--
-- Prior to GHC 8.12, 'TyVarBndrSpec' and 'TyVarBndrUnit' are simply type
...
-- | This instance is only @flag@-polymorphic on GHC 8.12 or later, since
...
-- pre-8.12 versions of GHC do not equip 'TyVarBndr' with a @flag@ type
